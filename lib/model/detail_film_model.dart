...
//
//     final detailFilmModel = detailFilmModelFromJson(jsonString);

import 'dart:convert';

DetailFilmModel detailFilmModelFromJson(String str) =>
    DetailFilmModel.fromJson(json.decode(str));

String detailFilmModelToJson(DetailFilmModel data) =>
